...
class PetFriends:
    """API библиотека для web application "Pet Friends" """
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        """Метод направляет запрос к API сервера и возвращает статус запроса и результат в формате JSON
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет (post) на сервер данные о добавляемом питомце и возвращает статус
    ...
    def post_new_pet_simple(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
    ...
    def post_pets_set_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        #добавление фото в профайл ранее добавленного питомца
